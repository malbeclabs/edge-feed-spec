...
var testedRules = map[string]string{
	...
	"MBP.DELTA.ABSOLUTE_APPLY":                     "TestMBPAbsoluteApplyPairsZeroWithDelete (mbp_consumer_test.go)",
	"MBP.SNAP.GROUP_STRUCTURE":                     "TestMBPSnapshotGroupStructure (mbp_consumer_test.go)",
	"MBP.SNAP.RECONSTRUCTED_BOOK_MATCHES_SNAPSHOT": "TestMBPReconstructedBookMatchesSnapshot (mbp_consumer_test.go)",
