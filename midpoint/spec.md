...
This document specifies version **0.2.0**: the frame header, application message header, and the message types sufficient to operate a working midpoint publisher and subscriber.
